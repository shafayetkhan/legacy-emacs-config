...
** Basic housekeeping
   Switch default shell to zsh. Use config from OH MY ZSH. Install XCode command
   line tools.
...
#+END_SRC
   ...
   Install the latest version of org-mode. Instructions to install org-mode can
   be found [[http://orgmode.org/manual/Installation.html][here]].
